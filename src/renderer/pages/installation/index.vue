      ...
      <div class="card-content">
        <div class="content has-text-light pt-6">
          <div style="width: 500px">
            <p>
             Lekol est la solution de gestion d’inscription et de
              gestion des frais de scolarité, du personnel administratif , du personnel enseignant facile à utiliser, qui vous
              permettra de constituer facilement une base de données complètes
              de vos inscrits, calculer en un tant record les resultats scolaires
            </p>
          </div>
          <div class="mt-6" style="padding-top: 100px">
            <b-button
              ...
              @click="$router.push('/installation/inscription')"
              rounded
              >Suivant</b-button
            >
